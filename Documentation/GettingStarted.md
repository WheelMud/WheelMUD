...
* [.NET Core 2.2.203](https://github.com/dotnet/core/blob/master/release-notes/2.2/2.2.203-SDK/2.2.203-SDK-download.md) SDK (for development) or Runtime Binaries (to run the server without the SDK).
